...
//     if (!LINE2.includes(start) || !LINE2.includes(end)) {
//       throw new Error('존재하지 않는 역입니다.');
//     }
//     this.start = start;
//     this.end = end;
//     this.route = this._makeRoute();
//     this._currentIndex = -1;
//   }

//   _makeRoute() {
//     const sIdx = LINE2.indexOf(this.start);
//     const eIdx = LINE2.indexOf(this.end);
//     if (sIdx <= eIdx) return LINE2.slice(sIdx, eIdx + 1);
//     return [...LINE2.slice(sIdx), ...LINE2.slice(0, eIdx + 1)];
//   }
...
//         if (i < route.length) {
//           const value = route[i];
//           this._currentIndex = i + 1 < route.length ? i + 1 : i;
//           i++;
...
//     toString() {
//       const current =
//         this._currentIndex >= 0 && this._currentIndex < this.route.length ?
//         `${this.route[this._currentIndex]}역` :
//         `${this.start}역`;
//       return `${this.start}역에서 ${this.end}역까지 가는 열차이며, 현재 ${current}입니다`;
//     }
//   }
